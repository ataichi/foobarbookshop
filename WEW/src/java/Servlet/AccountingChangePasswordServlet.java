 ...
 * @author Danica
 */
@WebServlet(name = "AccountingChangePasswordServlet", urlPatterns = {"/AccountingChangePasswordServlet"})
public class AccountingChangePasswordServlet extends HttpServlet {
