 ...
 * @author Danica
 */
@WebServlet(name = "ProductManagerChangePasswordServlet", urlPatterns = {"/ProductManagerChangePasswordServlet"})
public class ProductManagerChangePasswordServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                Logger.getLogger(ProductManagerChangePasswordServlet.class.getName()).log(Level.SEVERE, null, ex);
            }
