                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="adminAccount.jsp"><span class="glyphicon glyphicon-edit"></span> Account</a></li>
            ...
            <div class="row">
                <div class="panel panel-default">
                    ...
                    <div class="panel-body">
                        <form class="form-horizontal" role="form" id="admincheck" name="admincheck" onsubmit="return adminEditPassword();" action="AdminChangePasswordServlet" method="post">
                            <div>
