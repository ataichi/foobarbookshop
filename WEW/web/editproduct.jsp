                        ...
                        <form class="form-horizontal" role="form" id="productcheck" name="productcheck" action="FinalEditProductServlet" onsubmit="return productCheck(this)" method="post">
                            <div>
                                ...
                                <% if (prodType.equals("Audio CD")) {
                                        ...
                                        out.println("<div class='form-group'>"
                                                + "<label class='control-labelcol-lg-4' for='fname'>Author</label>"
                                                + "<div class='col-sm-3'>"
                                                + "<input type='text' class='form-control' id='bookAuthor' name='bookAuthor' onfocus='backWhite(this);' value='" + book.getAuthor() + "'/>"
                                                + "</div>"
                                                + "</div>"
                                                + "<div class='form-group'>"
                                                + "<labelclass='control-label col-lg-4' for='fname'>Publisher</label>"
                                                + "<div class='col-sm-3'>"
                                                ...
                                                + "<div class='col-sm-3'>"
                                                + "<input type='date' class='form-control' id='bookDatePublished' name='bookDatePubslihed' onfocus='backWhite(this);' value='" + book.getDatePublished() + "'/>"
                                                + "</div>"
                                                + "</div>");

                                    } else if (prodType.equals("DVD")) {
                                        out.println("<div class='form-group'>"
                                                + "<label class='control-labelcol-lg-4' for='fname'>Director</label>"
                                                + "<div class='col-sm-3'>"
                                                + "<input type='text' class='form-control' id='dvdDirector' name='dvdDirector' onfocus='backWhite(this);' value='" + dvd.getDirector() + "'/>"
                                                + "</div>"
                                                + "</div>"
                                                + "<div class='form-group'>"
                                                + "<labelclass='control-label col-lg-4' for='fname'>Actor</label>"
                                                + "<div class='col-sm-3'>"
                                        ...
                                        out.println("<div class='form-group'>"
                                                + "<label class='control-labelcol-lg-4' for='fname'>Volume Number</label>"
                                                + "<div class='col-sm-3'>"
                                                ...
                                                + "</div>"
                                                + "<div class='form-group'>"
                                                + "<labelclass='control-label col-lg-4' for='fname'>Issue Number</label>"
                                                + "<div class='col-sm-3'>"
                                                ...
                                                + "</div>"
                                                + "<div class='form-group'>"
                                                + "<label class='control-labelcol-lg-4' for='fname'>Date Published</label>"
                                                + "<div class='col-sm-3'>"
